...
import { CallVendorChangePassword } from "./CallVendorChangePassword.ts";
  ...
  return (
    <>
      <Flex
        ...
        borderRadius={"19px"}
      >
        <Flex bg={"ntl.150"} padding={"10px"} borderRadius={"9px"} >
          <Img src="/Assets/changePassword.svg" />
        </Flex>
        <Center alignItems={"flex-start"} minW={"500px"}>
          <Flex
            direction={"column"}
            justifyContent={"center"}
            alignContent={"center"}
            ...
            <Flex marginTop={"20px"}>
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  if (isFormValid) {
                    let check = "hello 1";
                    let result = CallVendorChangePassword(passData)
                      .then((res) => {
                        console.log(res);
                      })
                      .catch((errr) => {
...
export const VendorChangePassword = () => {
  return (
    <>
